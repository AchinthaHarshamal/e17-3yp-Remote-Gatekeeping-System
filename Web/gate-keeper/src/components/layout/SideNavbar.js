    ...
    return (
        <div>
            <ul id="signedInNav" className="sidenav   z-depth-0  indigo lighten-2 font1">
                ...
                <li><NavLink to='download'><i id='side-download' className="material-icons  white-text">get_app</i>Download app</NavLink></li>
                <li><NavLink to='faq'><i id='side-faq' className="material-icons  white-text">contact_support</i>FAQ</NavLink></li>
                <li><NavLink to='contactus'><i id='side-cart' className="material-icons  white-text">shopping_cart</i>Order Now!</NavLink></li>
            </ul>
